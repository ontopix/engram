...
var protocolCommandGoldens = []commandGolden{
	...
	{CommandHooksList, []string{"hooks", "list"}, "engram hooks list [--state accepted|working]", []string{"hooks", "list"}, StoreAllowed},
	{CommandHooksTrust, []string{"hooks", "trust"}, "engram hooks trust [--state accepted|working]", []string{"hooks", "trust"}, StoreAllowed},
